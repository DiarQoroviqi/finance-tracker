                ...
                <div class="relative z-40 md:hidden" role="dialog" aria-modal="true">
                    <!--
                      ...
                      Leaving: "transition-opacity ease-linear duration-300"
                        ...
                        To: "opacity-0"
                    -->
                    <div :class="sidebarOpen ? 'opacity-100' : 'opacity-0'" class="fixed inset-0 bg-gray-600 bg-opacity-75 transition-opacity ease-linear duration-300"></div>
                    ...
                    <div class="fixed inset-0 z-40 flex">
                        <!--
                          ...
                          Leaving: "transition ease-in-out duration-300 transform"
                            ...
                            To: "-translate-x-full"
                        -->
                        <div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="relative flex w-full max-w-xs flex-1 flex-col bg-white pt-5 pb-4 transition ease-in-out duration-300 transform">
                            <!--
                              ...
                              Leaving: "ease-in-out duration-300"
                                ...
                                To: "opacity-0"
                            -->
                            <div :class="sidebarOpen ? 'opacity-100' : 'opacity-0'" class="absolute top-0 right-0 -mr-12 pt-2 ease-in-out duration-300">
                                <button @click="toggleSidebar()" type="button" class="ml-1 flex h-10 w-10 items-center justify-center rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                    ...
                    <div class="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white shadow">
                        ...
                        <div class="flex flex-1 justify-end px-4">
                            <div class="ml-4 flex items-center md:ml-6">
                                ...
                                <!-- Profile dropdown -->
                                <div x-data="{ showProfileMenu: false }" class="relative ml-3">
                                    <div>
                                        <button @click="showProfileMenu = ! showProfileMenu" type="button" class="flex max-w-xs items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <div x-show="showProfileMenu"
                                         class="transition ease-out duration-100 transform absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
